...
$('previewBtn').addEventListener('click', () => {
  ...
  const previewElement = document.querySelector('#newsletterPreview .newsletter-preview') || document.querySelector('.newsletter-preview');
...
@media(max-width:760px){
  body{padding:10px;}
  .newsletter-preview{max-width:100%;}
}
</style>
