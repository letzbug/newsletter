...
function youtubeThumbnail(url) {
  const u = clean(url);
  const match = u.match(/(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([A-Za-z0-9_-]{6,})/i);
...
function contentBlockMediaHtml(block, compact = false) {
    ...
    if (thumbnail) {
      return `
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;border-collapse:collapse;">
          <tr>
            <td align="center" style="padding:0 0 ${compact ? '0' : '16px'};">
          ...
          <tr>
            <td align="center" style="padding:0 0 ${compact ? '0' : '14px'};">
              <span style="display:inline-block;background:#0d1f59;color:#ffffff;border-radius:999px;padding:9px 16px;font-size:14px;font-weight:900;font-family:Arial,Helvetica,sans-serif;">▶ Voir la vidéo</span>
            </td>
          </tr>
        </table>`;
    }
      ...
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;border-collapse:collapse;background:#0d1f59;border-radius:12px;">
        <tr>
          <td align="center" style="padding:40px 20px;color:#ffffff;font-size:46px;font-weight:900;font-family:Arial,Helvetica,sans-serif;">
            ▶<br><span style="font-size:15px;line-height:1.4;">Voir la vidéo</span>
          </td>
        </tr>
      </table>`;
  }
...
function mailjetContentBlock(block) {
  ...
  const media = contentBlockMediaHtml(block, position !== 'top');
...
function mailjetCustomBlocks() {
  return customBlocks.map(block => {
    ...
    return mailjetContentBlock(block);
  }).join('');
}
